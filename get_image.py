...
if __name__ == "__main__":
    ...
    while True:
        ...
        if frame != None:
            ...
            filename_b = f'black_image_{time_str}.jpg'
            cv2.imwrite(filename_b, result_image)
            ...
            filename_color = f'color_image_{time_str}.jpg'
            cv2.imwrite(filename_color, result_image)
